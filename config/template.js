...
exports.forgotPass = function (result, callback) {
	...
	var template = `
		<html>
			...
			<body>
				<p>Hello ${result[0].user_name},</p><br>
				<p>You recently requested to reset the password for your account. Click the button below to proceed.</p><br>
				<center><a href='http://localhost:8188/api/v1/auth/resetform/${result[0].id}' style="padding:10px;background-color:skyblue;color:white">Password Reset</a></center><br>
